 ...
 *
 */
public class BBConnectionProvider implements ConnectionProvider {
    
    private int more = 0;
    private static int successful = 0;
    
    public ConnectionProvider clone() {
        return new BBConnectionProvider();
    }
    ...
    public Connection getNextConnection(String url, boolean arg1)
    	...
    	return getAConnection(url,more);
    ...
    private Connection getAConnection(String url, int toGet) 
        throws IOException {
    	successful = more = HTTPGetConnection.id;
