...
public class HttpsMD5ConnectionFactory
{
	/**
	 ...
	 */
	public HttpsMD5ConnectionFactory( String url ) {
		this( url, null, 0 );
	}
	 ...
	 */
	public HttpsMD5ConnectionFactory( String url, int allowedTransports ) {
	 ...
	 */
	public HttpsMD5ConnectionFactory( String url, int transportPriority[] ) {
	 ...
	 */
	public HttpsMD5ConnectionFactory( String url, String extraParameters, int allowedTransports ) {
	 ...
	 */
	public HttpsMD5ConnectionFactory( String url, String extraParameters, int transportPriority[] ) {
	 ...
	 */
	public HttpsConnection getNextConnection() throws NoMoreTransportsException
	{
		...
		if( con == null )
		{
			throw new NoMoreTransportsException("empty");
		}
	 ...
	 */
	private HttpsConnection getBisConnection( int index ) throws NoMoreTransportsException, IOException
	{
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private HttpsConnection getBesConnection( ) throws IOException
	{
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private HttpsConnection getWifiConnection() throws IOException
	{
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private HttpsConnection getWap2Connection( int index ) throws NoMoreTransportsException, IOException
	{
	 ...
	 * @throws IOException throws exceptions generated by {@link getConnection( String transportExtras1, String transportExtras2 )}
	 */
	private HttpsConnection getTcpConnection( ) throws IOException
	{
		if( CoverageInfo.isCoverageSufficient( 1 /* CoverageInfo.COVERAGE_DIRECT */ ) )
		{
	 ...
	 */
	private HttpsConnection getConnection( String transportExtras1, String transportExtras2 ) throws IOException
	{
		...
		return (HttpsConnection)Connector.open( fullUrl.toString() );
	}
	...
	class NoMoreTransportsException extends Exception
	{
		...
		{
			System.out.println("No more transports available now");
		}
	}
}