...
public class CompanyFNODetailsSnippetsScreen extends MainScreen implements
	...
	private CompanyFNODetailsSnippetsScreen object = this;
	private Field field;
	...
	private CompanyFNODetailsSnippetsScreen cmp = this;
	private long timer;
	...
	public CompanyFNODetailsSnippetsScreen(HomeJson homeJson, int dateTextID,
			boolean addDirect) {
...
//			Dialog.alert("here   1");
	...
	public void createUI(final int dateTextID) {
		...
		// actionListener);
		bseBanner = new HomeScreenBanner(FIELD_HCENTER, "NSEFO", 0);
...
//				});
				...
				ReturnStringParser rparse = new ReturnStringParser(
						Utils.getCompanyFNOSearchURL_getData(homeJson
								.getCompanyCode()), 777, this);
			}
...
//	}
	...
	public void loadGraph() {
		...
		ChartItemParser chartCompanyDataParser = new ChartItemParser(
				Utils.getCompanyChartFNOData(homeJson.getCompanyCode()), this, 878);
