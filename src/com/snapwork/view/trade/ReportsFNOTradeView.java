...
public class ReportsFNOTradeView extends VerticalFieldManager implements ReturnString, ReturnDataWithId {
        ...
        public ReportsFNOTradeView(String url, Hashtable dataHolder,ActionListener actionListener) {
        		this.url = url;
        ...
        private class ReportsOrderGroupItem extends Manager {
           ...
           //             setPositionChild(getField(5), getPreferredWidth()-((bmp.getWidth()+2)*3), (getPreferredHeight()/2));
                        setPositionChild(getField(4), padding, (getPreferredHeight()-(getPreferredHeight()/4)));
                                ...
                                protected boolean navigationClick(int status,int time) {
                					...
                					{    if(caption.equalsIgnoreCase("Details"))
                						...
                						ReportsOrderView.Load = true;
                                             ...
                                             vec.addElement("FNO Trade Position");
                                             Vector e = new Vector();
                                             e.addElement(object);
                                             vec.addElement(e);
